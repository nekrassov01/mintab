...
func ExampleTable_Load_nil() {
	table := New(os.Stdout)
	if err := table.Load(nil); err != nil {
		log.Fatal(err)
	}
	table.Render()
...
func ExampleTable_Load_nodata() {
	table := New(os.Stdout)
	if err := table.Load(s1nodata); err != nil {
		log.Fatal(err)
	}
	table.Render()
...
func ExampleTable_Load_stringbuilder() {
...
var i3 = Input{
	Header: []string{"RequiredField", "UnneededField"},
	Data: [][]any{
		{"v1", "v1"},
		{"v2", "v2"},
	},
...
func ExampleTable_Load_input_basic() {
	table := New(os.Stdout)
	if err := table.Load(i1); err != nil {
		log.Fatal(err)
	}
	table.Render()
...
func ExampleTable_Load_input_nodata() {
	i1nodata := i1
	i1nodata.Data = nil
	table := New(os.Stdout)
	if err := table.Load(i1nodata); err != nil {
		log.Fatal(err)
	}
	table.Render()
...
func ExampleTable_Load_input_markdown() {
	table := New(os.Stdout, WithFormat(MarkdownFormat))
	if err := table.Load(i1); err != nil {
		log.Fatal(err)
	}
...
func ExampleTable_Load_input_backlog() {
	table := New(os.Stdout, WithFormat(BacklogFormat))
	if err := table.Load(i1); err != nil {
		log.Fatal(err)
	}
...
func ExampleTable_Load_input_disableheader() {
	table := New(os.Stdout, WithHeader(false))
	if err := table.Load(i1); err != nil {
		log.Fatal(err)
	}
...
func ExampleTable_Load_input_emptyfieldplaceholder() {
	table := New(os.Stdout, WithEmptyFieldPlaceholder("NULL"))
	if err := table.Load(i1); err != nil {
		log.Fatal(err)
	}
...
func ExampleTable_Load_input_worddelimiter() {
	table := New(os.Stdout, WithWordDelimiter(","))
	if err := table.Load(i1); err != nil {
		log.Fatal(err)
	}
...
func ExampleTable_Load_input_margin() {
	table := New(os.Stdout, WithMargin(3))
	if err := table.Load(i1); err != nil {
		log.Fatal(err)
	}
...
func ExampleTable_Load_input_mergefields1() {
	table := New(os.Stdout)
	if err := table.Load(i2); err != nil {
		log.Fatal(err)
	}
	table.Render()
...
func ExampleTable_Load_input_mergefields2() {
	table := New(os.Stdout, WithMergeFields([]int{0, 1, 2, 3}))
	if err := table.Load(i2); err != nil {
		log.Fatal(err)
	}
...
func ExampleTable_Load_input_mergefields3() {
	table := New(os.Stdout, WithFormat(CompressedTextFormat), WithMergeFields([]int{0, 1, 2, 3}))
	if err := table.Load(i2); err != nil {
		log.Fatal(err)
	}
...
func ExampleTable_Load_input_ignorefields1() {
	table := New(os.Stdout, WithIgnoreFields(nil))
	if err := table.Load(i3); err != nil {
		log.Fatal(err)
	}
	table.Render()
...
func ExampleTable_Load_input_ignorefields2() {
	table := New(os.Stdout, WithIgnoreFields([]int{1}))
	if err := table.Load(i3); err != nil {
		log.Fatal(err)
	}
...
func ExampleTable_Load_input_escape1() {
	table := New(os.Stdout, WithEscape(false))
	if err := table.Load(i4); err != nil {
		log.Fatal(err)
	}
	table.Render()
...
func ExampleTable_Load_input_escape2() {
	table := New(os.Stdout, WithFormat(MarkdownFormat), WithEscape(false))
	if err := table.Load(i4); err != nil {
		log.Fatal(err)
	}
...
func ExampleTable_Load_input_escape3() {
	table := New(os.Stdout, WithFormat(MarkdownFormat), WithEscape(true))
	if err := table.Load(i4); err != nil {
		log.Fatal(err)
	}
...
func ExampleTable_Load_input_stringbuilder() {
	builder := &strings.Builder{}
	table := New(builder)
	if err := table.Load(i2); err != nil {
		log.Fatal(err)
...
func ExampleTable_Load_input_noheader() {
	i1noheader := i1
	i1noheader.Header = []string{}
	table := New(os.Stdout)
	if err := table.Load(i1noheader); err != nil {
		log.Fatal(err)
	}
	table.Render()
...
func ExampleTable_Load_input_ptrc() {
	table := New(os.Stdout)
	if err := table.Load(&i1); err != nil {
		log.Fatal(err)
	}
